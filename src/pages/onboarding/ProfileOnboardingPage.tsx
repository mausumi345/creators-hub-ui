    ...
    const loadProfile = async () => {
      try {
        ...
        if (effectiveCountry === "US") {
          if (US_CITIES.includes(resolvedCity)) {
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 rounded-2xl border border-slate-200 bg-white text-slate-900 focus:outline-none focus:border-orange-300 focus:ring-1 focus:ring-orange-200 transition-colors"
              >
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-2xl border bg-white text-slate-900 placeholder:text-slate-400 focus:outline-none transition-colors ${
              ...
              />
              {(isEditExistingRole || !!displayName) && (
                <p className="mt-1 text-xs text-slate-500">Display name is locked after creation.</p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-8 pr-4 py-3 rounded-2xl border bg-white text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-1 transition-colors ${
                    handleError
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-2xl border border-slate-200 bg-white text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-orange-300 focus:ring-1 focus:ring-orange-200 transition-colors resize-none"
              />
              ...
              <div>
                ...
                {countryCode === "US" ? (
                  <>
                    ...
                    {citySelection === "OTHER" && (
                      <input
                        ...
                        className="mt-3 w-full px-4 py-3 rounded-2xl border border-slate-200 bg-white text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-orange-300 focus:ring-1 focus:ring-orange-200 transition-colors"
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-2xl border border-slate-200 bg-white text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-orange-300 focus:ring-1 focus:ring-orange-200 transition-colors"
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">
                Collaboration specialty <span className="text-orange-500">*</span>
              </label>
              {role === "DESIGNER" && (
                <div className="px-4 py-3 rounded-2xl border border-slate-200 bg-white text-slate-700">
              ...
              {role === "EXPLORER" && (
                <div className="px-4 py-3 rounded-2xl border border-slate-200 bg-white text-slate-500">
            ...
            <div className="flex items-center justify-between pt-4">
              <button
                ...
                className="px-6 py-3 rounded-2xl font-medium text-slate-500 border border-slate-200 hover:border-slate-300 hover:text-slate-900 transition-colors"
              >
                ← Back
              </button>
